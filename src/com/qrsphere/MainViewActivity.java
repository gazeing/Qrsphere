...
public class MainViewActivity extends Activity {
	...
	private int[] mImages = { R.drawable.scan_icon, R.drawable.history_icon,
			R.drawable.fav_icon, R.drawable.gear_icon,
			R.drawable.discover_icon, R.drawable.about_icon,

	};

	private String[] mTexts = { "Scan", "History", "Favorite", "More",
			"Discover", "About",
	...
	boolean isFromPopupMenu = false;// to identify if the page jumping is from
									// popup menu
	...
	private Handler handler = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			if (msg.what == SuccessCode.DETAIL_SENT_SUCCESS) {
				...
				Toast.makeText(MainViewActivity.this, "Network error!",
	...
	private void feedback() {
		...
		if (qc != null) {
			Intent intent = new Intent(new Intent(MainViewActivity.this,
	...
	private void Init() {
		...
		SimpleAdapter simple = new SimpleAdapter(this, lstImageItem,
				R.layout.gridviewitem, new String[] { "ItemImage" },
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				if (position == 0) {
					...
					startActivityForResult(new Intent(
							"com.qrsphere.scan.CaptureActivity"), nRet);
				} else if (position == 3) {

					startActivity(new Intent(MainViewActivity.this,
					...
					Toast toast = Toast.makeText(getApplicationContext(),
							"Sorry, to use this function, you have to login.",
							Toast.LENGTH_SHORT);
					toast.setGravity(Gravity.BOTTOM, 0, 0);
					toast.show();
				}
		...
		// click on the logo of titlebar will open the browser and go to
		// website.
		...
		bt_portrait.setBackgroundDrawable(getPortrait());
		...
		lv_group.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> adapterView, View view,
				...
				if (position == 1) {
					...
					MainViewActivity.this.finish();
					MainViewActivity.this.startActivity(new Intent(
